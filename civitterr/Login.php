...
<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    ...
    <button type="submit" class="login mdl-button"><i class="glyphicon glyphicon-ok"></i></button>
    <button type="button" id="SignUp" class="signup mdl-button"><i class="glyphicon glyphicon-plus"></i></button></div>
</form></div>
